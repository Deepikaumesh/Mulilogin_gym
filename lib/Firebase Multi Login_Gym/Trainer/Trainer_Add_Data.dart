...
class Trainer_add_Data extends StatefulWidget {
  ...
  @override
  _Trainer_add_DataState createState() => _Trainer_add_DataState();
}

class _Trainer_add_DataState extends State<Trainer_add_Data> {
  ...
  Future<void> uploadimage() async {
    ...
    CollectionReference collectionreference = FirebaseFirestore.instance.collection('Trainer_Add_Data');
